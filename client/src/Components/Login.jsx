...
function Login () {
  ...
  <div className="card-body">
    ...
    <div>
      ...
      <div>Username should be alphanumeric character only</div>
    </div>
    <div>
      <label for="exampleInputEmail1" className="form-label mt-4">Password</label>
      ...
      <div>Password is required<br/><br/></div>
    </div>
